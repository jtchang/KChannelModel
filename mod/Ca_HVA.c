...
extern Memb_func* memb_func;
 ...
 "efun_Ca_HVA", _hoc_efun,
 "rates_Ca_HVA", _hoc_rates,
 "trates_Ca_HVA", _hoc_trates,
 0, 0
};
#define efun efun_Ca_HVA
...
#define _gth 1
#define cai cai_Ca_HVA
 double cai = 0;
#define cao cao_Ca_HVA
 double cao = 2.5;
#define mshift mshift_Ca_HVA
 double mshift = 0;
#define q10 q10_Ca_HVA
 double q10 = 2.3;
#define tadj_Ca_HVA _thread1data[0]
#define tadj _thread[_gth]._pval[0]
#define temp temp_Ca_HVA
 double temp = 23;
#define vshift vshift_Ca_HVA
 double vshift = 0;
#define vmax vmax_Ca_HVA
 double vmax = 100;
#define vmin vmin_Ca_HVA
 double vmin = -120;
 ...
 "vshift_Ca_HVA", &vshift_Ca_HVA,
 "mshift_Ca_HVA", &mshift_Ca_HVA,
 "cao_Ca_HVA", &cao_Ca_HVA,
 "cai_Ca_HVA", &cai_Ca_HVA,
 "temp_Ca_HVA", &temp_Ca_HVA,
 "q10_Ca_HVA", &q10_Ca_HVA,
 "vmin_Ca_HVA", &vmin_Ca_HVA,
 "vmax_Ca_HVA", &vmax_Ca_HVA,
 "tadj_Ca_HVA", &tadj_Ca_HVA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 14, 4);
 	...
 	ivoc_help("help ?1 Ca_HVA C:/Models/L5_simpleModelParallel/mod/Ca_HVA.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lvm ) {
   double _la , _lb , _la_m , _lb_m ;
 tadj = pow( q10 , ( ( celsius - temp ) / 10.0 ) ) ;
   _la_m = 0.055 * ( - 27.0 - ( _lvm + mshift ) ) / ( exp ( ( - 27.0 - ( _lvm + mshift ) ) / 3.8 ) - 1.0 ) ;
   _lb_m = 0.94 * exp ( ( - 75.0 - ( _lvm + mshift ) ) / 17.0 ) ;
   _la = 0.055 * ( - 27.0 - _lvm ) / ( exp ( ( - 27.0 - _lvm ) / 3.8 ) - 1.0 ) ;
   _lb = 0.94 * exp ( ( - 75.0 - _lvm ) / 17.0 ) ;
   mtau = 1.0 / tadj / ( _la + _lb ) ;
   minf = _la_m / ( _la_m + _lb_m ) ;
