...
:Almog & Korngreen 2014 based on Almog & Korngreen 2009 PlosOne

:INDEPENDENT {t FROM 0 TO 1 WITH 1 (ms)} -jtc modification to see if this fixes the blocky nature of the responses, also its unnecessary in NMODL
